...
g1_23dof_wbt = ExperimentConfig(
    training=TrainingConfig(
        project="WholeBodyTracking",
        name="g1_23dof_wbt_manager",
        num_envs=4096,
    ),
    ...
    robot=replace(
        robot.g1_23dof,
        control=replace(
            robot.g1_23dof.control,
            action_scale=0.25,
            action_scales_by_effort_limit_over_p_gain=True,
        ),
        asset=replace(robot.g1_23dof.asset, enable_self_collisions=True),
        init_state=replace(robot.g1_23dof.init_state, pos=[0.0, 0.0, 0.76]),
    ),
    terrain=terrain.terrain_locomotion_plane,
    observation=observation.g1_23dof_wbt_observation,
    action=action.g1_23dof_joint_pos,
    termination=termination.g1_23dof_wbt_termination,
    randomization=randomization.g1_23dof_wbt_randomization,
    command=command.g1_23dof_wbt_command,
    curriculum=curriculum.g1_23dof_wbt_curriculum,
    reward=reward.g1_23dof_wbt_reward,
...
g1_23dof_wbt_fast_sac = ExperimentConfig(
    ...
    command=command.g1_23dof_wbt_command,
    curriculum=curriculum.g1_23dof_wbt_curriculum,
    reward=reward.g1_23dof_wbt_fast_sac_reward,
    nightly=NightlyConfig(
        iterations=200000,
        metrics={
...
g1_23dof_wbt_w_object = replace(
    g1_23dof_wbt,
    command=command.g1_23dof_wbt_command_w_object,
    robot=replace(
        robot.g1_23dof_w_object,
        asset=replace(
            robot.g1_23dof_w_object.asset,
            enable_self_collisions=True,
        ),
        object=replace(
            robot.g1_23dof_w_object.object,
            object_urdf_path="holosoma/data/motions/g1_23dof/whole_body_tracking/objects_largebox.urdf",
        ),
        init_state=replace(robot.g1_23dof_w_object.init_state, pos=[0.0, 0.0, 0.76]),
    ),
    randomization=randomization.g1_23dof_wbt_randomization_w_object,
    observation=observation.g1_23dof_wbt_observation_w_object,
    reward=reward.g1_23dof_wbt_reward_w_object,
    simulator=replace(
        simulator.isaacsim,
...
g1_23dof_wbt_fast_sac_w_object = replace(
    ...
    robot=replace(
        robot.g1_23dof_w_object,
        asset=replace(robot.g1_23dof_w_object.asset, enable_self_collisions=True),
        object=replace(
            robot.g1_23dof_w_object.object,
            object_urdf_path="holosoma/data/motions/g1_23dof/whole_body_tracking/objects_largebox.urdf",
        ),
...
python src/holosoma/holosoma/train_agent.py \
  ...
  --terrain.terrain-term.obj-file-path="holosoma/data/motions/g1_23dof/whole_body_tracking/terrain_slope.obj" \
  --command.setup_terms.motion_command.params.motion_config.motion_file\
="holosoma/data/motions/g1_23dof/whole_body_tracking/motion_crawl_slope.npz" \
