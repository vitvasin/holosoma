...
motion_config = MotionConfig(
    motion_file="holosoma/data/motions/g1_23dof/whole_body_tracking/sub3_largebox_003_mj.npz",
    body_names_to_track=[
        "pelvis",
        "left_hip_roll_link",
        "left_knee_link",
...
motion_config_w_object = replace(
    motion_config,
    motion_file="holosoma/data/motions/g1_23dof/whole_body_tracking/sub3_largebox_003_mj_w_obj.npz",
)
